...
async function sendEmailWithLinking(to, subject, body, options = {}) {
...
function multipart(body, filename, contentType, attachment) {
...
const attchment = (path, type, name) => {
  return {
